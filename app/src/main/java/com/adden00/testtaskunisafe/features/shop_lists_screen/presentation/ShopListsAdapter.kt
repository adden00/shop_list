...
class ShopListsAdapter(private val onClickCallback: (ShopListModel)->Unit): ListAdapter<ShopListModel, ShopListsAdapter.ItemHolder>(object : DiffUtil.ItemCallback<ShopListModel>() {
